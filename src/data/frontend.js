export const nodes = [
  {
    ...
    data: {
      ...
      difficulty: 'Beginner',
      resources: [
        { title: 'HTMLCSS by Aman', url: 'https://aman-0402.github.io/HTMLCSS/', description: 'Curated HTML & CSS notes and reference' },
        ...
        { title: 'htmlreference.io', url: 'https://htmlreference.io/', description: 'Visual HTML element reference' },
      ],
      prerequisite: null,
      topic: {
...
• Meta tags and SEO basics`,
        videos: [
          { title: 'HTML Tutorial for Beginners | Complete HTML with Notes & Code', url: 'https://youtu.be/HcOc7P5BMi4?si=RM3T5TypR_DnTA74' },
          { title: 'Learn HTML, CSS and JavaScript in Single Video | Basics of MERN Stack', url: 'https://youtu.be/kkOuRJ69BRY?si=n_keIuybzTF_ggYd' },
        ],
        projects: [
          ...
          'Recreate a Wikipedia-style article page with full semantic structure',
          'Create a job application form with all input types, fieldsets, and labels',
          'Build an HTML email template using tables-based layout',
          'Create a product landing page with hero, features, and CTA sections',
          'Build a FAQ page using definition lists (dl, dt, dd)',
          'Create a travel itinerary with nested lists, tables, and anchor navigation',
          'Build an accessible image gallery using figure, figcaption, and alt text',
        ],
        practice: [
          'Create a form with every input type: text, email, password, radio, checkbox, select, textarea, date, range, file',
          'Build a semantic news article layout with header, article, aside, and footer',
          'Recreate a Wikipedia article page structure — headings, sections, infobox table, references',
          'Build a 3-column table with thead, tbody, tfoot, colspan, and rowspan',
          'Create a nested navigation menu using only ul and li elements',
          'Add Open Graph meta tags to a page for correct social sharing previews',
          'Build an accessible image gallery — every image has descriptive alt, wrapped in figure/figcaption',
          'Embed a video with the <video> tag, custom poster image, and fallback text',
          'Write a page that passes W3C HTML validator with zero errors or warnings',
          'Build a glossary page using dl/dt/dd for 10 web development terms',
        ],
      },
    },
  },
